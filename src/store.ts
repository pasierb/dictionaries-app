...
export function updateDictionaryAction(dictionary: DictionaryModel): UpdateDictionaryAction {
	return {
...
export function deleteDictionaryAction(dictionary: DictionaryModel): DeleteDictionaryAction {
	return {
...
export function dictionaries(state: DictionaryModel[] = [], action: Action): DictionaryModel[] {
	switch (action.type) {
